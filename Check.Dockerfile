...
CMD  rsync -a --include ${GRADLE_USER_CACHE}/caches --exclude ${GRADLE_USER_CACHE}/caches/*.lock --include ${GRADLE_USER_CACHE}/wrapper --exclude ${GRADLE_USER_CACHE}/*/ ${GRADLE_USER_HOME} || true && \
